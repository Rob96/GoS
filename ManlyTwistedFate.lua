...
function ManlyTwistedFate:LoadMenu()
  ...
  self.Menu.Combo:MenuElement({id = "QMin", name = "Min range for Q in combo", value = 0, min = 0, max = 1250, step = 1})
  self.Menu.Combo:MenuElement({id = "QMax", name = "Max range for Q in combo", value = 500, min = 0, max = 1250, step = 1})
  self.Menu.Combo:MenuElement({id = "QMana", name = "Min mana for Q in combo in in %", value = 30, min = 0, max = 100, step = 1})
  ...
  self.Menu.Misc:MenuElement({id = "Order", name = "Skill Priority", drop = {"[Q] - [W] - [E] > Max [Q]","[Q] - [E] - [W] > Max [Q]","[W] - [Q] - [E] > Max [W]","[W] - [E] - [Q] > Max [W]","[E] - [Q] - [W] > Max [E]","[E] - [W] - [Q] > Max [E]", "ADTF"}})
...
function ManlyTwistedFate:AutoLevel()
  ...
  local Sequence = {
    ...
    [7] = { HK_W, HK_E, HK_W, HK_E, HK_W, HK_R, HK_E, HK_W, HK_E, HK_W, HK_R, HK_E, HK_Q, HK_Q, HK_Q, HK_R, HK_Q, HK_Q },
  }
  local Slot = nil
  local Tick = 0
...
function ManlyTwistedFate:Combo()
  ...
  if self.Menu.Combo.Q:Value() and Ready(_Q) and myHero.pos:DistanceTo(target.pos) >= QMin and myHero.pos:DistanceTo(target.pos) <= QMax and myHero.mana/myHero.maxMana >= QMana then
