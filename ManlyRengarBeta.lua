...
function Rengar:LoadMenu()
  ...
  self.Menu.Combo:MenuElement({id = "EmpQ", name = "Empower Q", value = true})
  self.Menu.Combo:MenuElement({id = "EmpW", name = "Empower W", value = false})
  self.Menu.Combo:MenuElement({id = "EmpE", name = "Empower E", value = false})
  -- Clear
...
function Rengar:Tick()
  ...
  if _G.SDK.Orbwalker.Modes[_G.SDK.ORBWALKER_MODE_COMBO] and self.Menu.Combo.EmpQ:Value() then
    self:ComboQ()
    return end

  if _G.SDK.Orbwalker.Modes[_G.SDK.ORBWALKER_MODE_COMBO] and self.Menu.Combo.EmpW:Value() then
    self:ComboW()
    return end

  if _G.SDK.Orbwalker.Modes[_G.SDK.ORBWALKER_MODE_COMBO] and self.Menu.Combo.EmpE:Value() then
    self:ComboE()
    return end
